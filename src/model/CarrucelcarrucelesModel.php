...
class CarruselcarruselesModel  extends \Franky\Database\Mysql\objectOperations
{

    public function __construct()
    {
      parent::__construct();
      $this->from()->addTable('carrusel_carruseles');
    }
    ...
    function getData($data = array())
    {
        ...
        foreach($data as $k => $v)
        {
            $this->where()->addAnd("carrusel_carruseles.".$k,$v,'=');
        }
